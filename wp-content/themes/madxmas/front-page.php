...
<!-- ARCH IMAGE CAROUSEL -->
            <div class="arch">
                <img class="arch-bg" src="<?php echo get_template_directory_uri();?>/img/arch-bg.png" />
...
<!-- VIDEO -->
    <!-- <div class="christmas-video" style="background-image: url('<?php echo get_template_directory_uri();?>/img/snowflake-BG.jpg')">
    <iframe src="https://player.vimeo.com/video/63543468?h=67b45032d7?badge=0&amp;autopause=0&amp;autoplay=1&amp;loop=1&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Syntrio - Wendell"></iframe>
